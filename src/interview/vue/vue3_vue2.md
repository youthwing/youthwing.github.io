...
![](../../image/interview-vue-44.png)

#### 更好的 Typescript 支持

`VUE3`是基于`typescipt`编写的，可以享受到自动的类型定义提示

![](../../image/interview-vue-45.png)

#### 编译器重写

![](../../image/interview-vue-46.png)

### 更接近原生

可以自定义渲染 API

![](../../image/interview-vue-47.png)

### 更易使用

响应式 `Api` 暴露出来

![](../../image/interview-vue-48.png)

轻松识别组件重新渲染原因

![](../../image/interview-vue-49.png)
...
![](../../image/interview-vue-51.png)

关于`compositon api`的使用，这里以下图展开

![](../../image/interview-vue-52.png)
