...
![](../../image/interview-git-32.png)

通过`git rebase`，会变成如下情况：

![](../../image/interview-git-33.png)

在移交过程中，如果发生冲突，需要修改各自的冲突，如下：

![](../../image/interview-git-34.png)

`rebase`之后，`master`的`HEAD`位置不变。因此，要合并`master`分支和`bugfix`分支

![](../../image/interview-git-35.png)
