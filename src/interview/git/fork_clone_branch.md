...
![](../../image/interview-git-20.png)

转到`git`仓库中，`fork`则可以代表分叉、克隆 出一个（仓库的）新拷贝

![](../../image/interview-git-21.png)
...
![](../../image/interview-git-22.png)

通过`git branch `可以创建一个分支，但并不会自动切换到新分支中去

![](../../image/interview-git-23.png)

通过`git checkout`可以切换到另一个`testing`分支

![](../../image/interview-git-24.png)
